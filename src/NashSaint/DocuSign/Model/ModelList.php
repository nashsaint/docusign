...
class ModelList implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'list_items' => '\DocuSign\Model\ListItem[]',
        'list_selected_value' => '?string',
        'list_selected_value_metadata' => '\DocuSign\Model\PropertyMetadata',
     ...
     * Gets list_items
     *
     * @return \DocuSign\Model\ListItem[]
     */
     ...
     * Sets list_items
     *
     * @param \DocuSign\Model\ListItem[] $list_items The list of values that can be selected by senders. The list values are separated by semi-colons. Example: [one;two;three;four]  Maximum Length of listItems:  2048 characters. Maximum Length of items in the list: 100 characters.
     *
     * @return $this
     */
     ...
     *
     * @param \DocuSign\Model\PropertyMetadata $list_selected_value_metadata list_selected_value_metadata
     *
     * @return $this
     */
